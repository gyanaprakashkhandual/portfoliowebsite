// ============================================================
//  PORTFOLIO SCRIPT — Gyana Prakash Khandual
// ============================================================
...
function renderHero() {
  ...
  document.getElementById('hero-section').innerHTML = `
    ...
    <div class="hero-content">
      ...
      <p class="hero-role">${p.title} · Full Stack Developer</p>
    ...
    <div class="hero-image-wrap">
      <div class="hero-image-frame">
        <img class="hero-img" src="${p.image}" alt="${p.name}" loading="eager" />
        <div class="hero-image-deco"></div>
        <div class="hero-stats">
          <div class="hero-stat">
            <span class="hero-stat-num">${portfolioData.projects.length}</span>
          ...
          <div class="hero-stat">
            <span class="hero-stat-num">${portfolioData.skills.length}</span>
